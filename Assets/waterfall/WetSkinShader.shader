Shader "Unlit/WetSkinShader"
{
	...
	_DisplAmount("Displacement amount", float) = 0
		...
		_BottomFoamThreshold("Bottom foam threshold", Range(-5,1)) = 0.1
	}
...
#include "UnityCG.cginc"
	...
	fixed4 frag(v2f i) : SV_Target
	{
		...
		//Noise
		half noise = tex2D(_NoiseTex, float2(i.noiseUV.x, i.noiseUV.y + _Time.y * 2) + displ).x;
